...
import colorPicker.math.Illuminant
import colorPicker.math.WhitePoint
...
object RGBColorSpaces {
     ...
     */
    val SRGB: RGBColorSpace = colorPicker.math.model.SRGB
...
object SRGB : RGBColorSpace {
    ...
    override fun create(components: FloatArray): RGB = doCreate(components, SRGB::invoke)
...
private object BT2020Space : RGBColorSpace {
    ...
    override fun create(components: FloatArray): RGB = doCreate(components, BT2020Space::invoke)
